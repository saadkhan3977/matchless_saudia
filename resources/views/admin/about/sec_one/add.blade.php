            ...
            <div class="box-body">
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm active" id="tab_1">
                  <form role="form" method="post" action="{{route('about_sec_one.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="link" required="" placeholder="Enter Link">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Link Text</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="link_text" required="" placeholder="Enter Link Test">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane p-v-sm" id="tab_2"  dir="rtl">
                  <form role="form" method="post" action="{{route('about_sec_one.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="link" required="" placeholder="أدخل الارتباط">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">زر كتابة</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="link_text" required="" placeholder="أدخل نص الزر">
                    </div>
                    <div class="form-group">
