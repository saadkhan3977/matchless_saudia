            ...
            <div class="box-body">
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('about_sec_one.update',$data->id)}}">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" value="{{$data->link}}" name="link" required="" placeholder="Enter Link">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Link Text</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="link_text" value="{{$data->link_text}}" required="" placeholder="Enter Link Test">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'ar') active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('about_sec_one.update',$data->id)}}">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">URL رابط</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" value="{{$data->link}}" name="link" required="" placeholder="أدخل الارتباط">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">زر كتابة</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" value="{{$data->link_text}}" name="link_text" required="" placeholder="أدخل نص الزر">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="{{ route('about_sec_one.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
