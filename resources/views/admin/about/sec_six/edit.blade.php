            ...
            <div class="box-body">
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('about_sec_six.update',$data->id)}}">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="sub_description" class="form-control" id="" cols="30" rows="10">{{$data->sub_description}}</textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Image</label>
                      <input type="file" class="form-control" id="exampleInputEmail1" name="image" value="{{$data->video_url}}"  placeholder="Enter Link">
                    </div>
