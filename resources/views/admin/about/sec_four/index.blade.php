    ...
    <div ui-view class="app-body" id="view">
            ...
            <div class="modal fade" id="modal-id">
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm  @if(!$en && $ar) active @endif " id="tab_1">
                  <form role="form" method="post" action="{{route('about_sec_four_heading')}}" enctype="multipart/form-data">
                  @csrf
              ...
              <tbody>
                @foreach($headingdata as $row)
                  ...
                  <td style="display: flex;">
                    ...
                    <form method="post" action="{{route('about_sec_four_heading_destroy',$row->id)}}">
                      @csrf
                      @method('delete')
                        ...
                        <div class="modal-content">
                          ...
                          <div class="tab-content">      
                            ...
                            <div class="tab-pane p-v-sm @if($row->lang == 'en') active @endif" id="tab_1">
                              <form role="form" method="post" action="{{route('about_sec_four_heading_update',$row->id)}}" enctype="multipart/form-data">
                              @csrf
                              @method('put')
                              <div class="modal-body">
                                <div class="form-group">
      ...
      {{-- <div class="box">
          <div class="box-header">
            <h3>Slider</h3>
            <br>
            <a class="btn btn-default generalsetting_admin" data-toggle="modal" href='#modal-iddd'>Add</a>
            <div class="modal fade" id="modal-iddd">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <form role="form" method="post" action="/admin/about/sec_four_slider" enctype="multipart/form-data">
                  @csrf
                  <div class="modal-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Title</label>
