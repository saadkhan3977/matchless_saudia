          ...
          <div class="box-divider m-0"></div>
            <div class="box-body">
              ...
              <div class="tab-content">      
                {{-- English Form Start --}}
                <div class="tab-pane p-v-sm  @if(count($en) < '3') active @endif " id="tab_1">
                  <form role="form" method="post" action="{{route('about_sec_two.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="{{ route('about_sec_two.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                  </form>
                </div>
                <div class="tab-pane p-v-sm @if(!$ar && $en) active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" action="{{route('about_sec_two.store')}}" enctype="multipart/form-data">
                    ...
                    <a href="{{ route('about_sec_two.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
                  </form>
                </div>
            </div>
          </div>
