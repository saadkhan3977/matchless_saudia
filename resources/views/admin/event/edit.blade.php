                    ...
                    <div class="row">
                      <div class="col-md-9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="exampleInputEmail1" value="{{$data->start_date}}" name="start_date" required="" placeholder="Start Date">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">End Date</label>
                            <input type="datetime-local" class="form-control" id="exampleInputEmail1" value="{{$data->end_date}}" name="end_date" required="" placeholder="End Date">
                          </div>
                        </div>
                        </div>
                        <div class="form-group">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="checkbox" class="form-control"  id="search" name="feature" required="">
                        </div>
                      ...
                      <div class="col-md-9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="exampleInputEmail1" value="{{$data->start_date}}" name="start_date" required="" placeholder="تاريخ البدء">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">تاريخ الانتهاء</label>
                            <input type="datetime-local" class="form-control" id="exampleInputEmail1" value="{{$data->end_date}}" name="end_date" required="" placeholder="تاريخ الانتهاء">
                          </div>
                        </div>
                        </div>
                        <div class="form-group">
