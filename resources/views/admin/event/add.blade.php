              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm active" id="tab_1">
                  <form role="form" method="post" action="{{route('schedule.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="col-md-9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="exampleInputEmail1" name="start_date" required="" placeholder="Start Date">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Start Time</label>
                            <input type="time" class="form-control" id="exampleInputEmail1" name="start_time" required="" placeholder="End Date">
                          </div>
                        </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="exampleInputEmail1" name="end_date" required="" placeholder="Start Date">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">End Time</label>
                            <input type="time" class="form-control" id="exampleInputEmail1" name="end_time" required="" placeholder="End Date">
                          </div>
                        </div>
                        </div>
                    ...
                    <a href="{{ route('schedule.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                  </form>
                </div>
                <div class="tab-pane p-v-sm" id="tab_2"  dir="rtl">
                  <form role="form" method="post" action="{{route('schedule.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="col-md-9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="exampleInputEmail1" name="start_date" required="" placeholder="تاريخ البدء">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">تاريخ الانتهاء</label>
                            <input type="datetime-local" class="form-control" id="exampleInputEmail1" name="end_date" required="" placeholder="تاريخ الانتهاء">
                          </div>
                        </div>
                        </div>
                        <div class="form-group">
                    ...
                    <a href="{{ route('schedule.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
                  </form>
                </div>
              </div>
            </div>
