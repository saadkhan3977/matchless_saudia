            ...
            <div class="box-body">
              ...
              {{-- English Form Start --}}
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('testimonial.update',$data->id)}}">
                    @csrf
                    @method('put')
                    <div class="form-group">
                      <label for="exampleInputEmail1">Title</label>
                      <input type="text" class="form-control" value="{{$data->client_name}}" id="exampleInputEmail1" name="client_name" required="" placeholder="Enter Title">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="{{ route('testimonial.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                  </form>
                </div>
                <div class="tab-pane p-v-sm @if($data->lang == 'ar') active @endif" id="tab_2"  dir="rtl">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('testimonial.update',$data->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="{{$data->client_name}}" id="exampleInputEmail1" name="client_name" required="" placeholder="اسم العميل">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="{{ route('testimonial.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
