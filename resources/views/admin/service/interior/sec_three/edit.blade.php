            ...
            <div class="box-body">
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('interior_sec_three.update',$data->id)}}">
                    @csrf
                    @method('put')
                    ...
                    <a href="{{ route('interior_sec_three.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'ar') active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('interior_sec_three.update',$data->id)}}">
                    ...
                    <a href="{{ route('interior_sec_three.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
