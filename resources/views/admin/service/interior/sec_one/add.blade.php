      ...
      <div class="padding">
        <div class="box">
          <div class="box-divider m-0"></div>
            <div class="box-body">
              <h3>Create Interior Section 1</h3>
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if(!$en && $ar) active @endif" id="tab_1">
                  <form role="form" method="post" action="{{route('interior_sec_one.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="subtitle" required="" id="exampleInputEmail1" placeholder="Enter Sub Title">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Image</label>
                      <input type="file" class="form-control generalsetting_admin" name="image" required="" id="exampleInputEmail1">
                    </div>
                ...
                <div class="tab-pane p-v-sm @if(!$ar && $en) active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" action="{{route('interior_sec_one.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="subtitle" required="" id="exampleInputEmail1" placeholder="أدخل العنوان الفرعي">
                    </div>
                    <div class="form-group">
