      ...
      <div class="padding">
        <div class="box">
          <div class="box-divider m-0"></div>
            <div class="box-body">
              <h3>Create Interior Section 4</h3>
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm active" id="tab_1">
                  <form role="form" method="post" action="{{route('interior_sec_four.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="{{ route('interior_sec_four.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                ...
                <div class="tab-pane p-v-sm" id="tab_2"  dir="rtl">
                  <form role="form" method="post" action="{{route('interior_sec_four.store')}}" enctype="multipart/form-data">
                    ...
                    <a href="{{ route('interior_sec_four.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
                  </form>
                </div>
              </div>
          </div>
