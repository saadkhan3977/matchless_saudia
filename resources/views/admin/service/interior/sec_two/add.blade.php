      ...
      <div class="padding">
        <div class="box">
          <div class="box-divider m-0"></div>
            <div class="box-body">
              <h3>Create Home Section 2</h3>
              <ul class="nav nav-pills nav-sm">
                <li class="nav-item active" @if(count($en) == '3') style="display: none" @endif>
                  <a class="nav-link generalsetting_admin" href data-toggle="tab" style="margin-right: 5px;" data-target="#tab_1">EN</a>
                </li>
                <li class="nav-item" @if(count($ar) == '3') style="display: none" @endif>
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if(!$en && $ar) active @endif " id="tab_1">
                  <form role="form" method="post" action="{{route('interior_sec_two.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control" required="" id="exampleInputEmail1" required="" name="image">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="{{ route('interior_sec_two.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                ...
                <div class="tab-pane p-v-sm @if(!$ar && $en) active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" action="{{route('interior_sec_two.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="description" required="" placeholder="أدخل النص">
                    </div>
                    <button type="submit" class="btn white m-b generalsetting_admin">إرسال</button>
                    <a href="{{ route('interior_sec_two.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
                  </form>
                </div>
              </div>
