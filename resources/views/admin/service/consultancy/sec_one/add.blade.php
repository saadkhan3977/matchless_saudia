      ...
      <div class="padding">
        <div class="box">
          <div class="box-divider m-0"></div>
            <div class="box-body">
              <h3>Create Consultancy Section 1</h3>
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm active" id="tab_1">
                  <form role="form" method="post" action="{{route('consultancy_sec_one.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="subtitle" required="" placeholder="Enter Sub Title">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane p-v-sm" id="tab_2"  dir="rtl">
                  <form role="form" method="post" action="{{route('consultancy_sec_one.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="subtitle" required="" placeholder="أدخل العنوان الفرعي">
                    </div>
                    <div class="form-group">
