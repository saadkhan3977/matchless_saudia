            ...
            <div class="box-body">
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('consultancy_sec_three.update',$data->id)}}">
                    @csrf
                    @method('put')
