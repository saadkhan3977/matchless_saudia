    ...
    <div ui-view class="app-body" id="view">
      ...
      <div class="padding">
          ...
          <div class="box-header">
            <h3>Career Section 2 Heading</h3>
            <br>
                ...
                <div class="modal-content">
                  ...
                  <div class="tab-content">      
                    ...
                    <div class="tab-pane p-v-sm  @if(!$en && $ar) active @endif " id="tab_1">
                      <form role="form" method="post" action="{{route('sec_two_heading')}}" enctype="multipart/form-data">
                      @csrf
                ...
                @foreach($headingdata as $headingrow)
                  <tr>
                    ...
                    <td style="display: flex;">
                      <a style="margin-right: 10px;" class="btn btn-default generalsetting_admin" data-toggle="modal" href='#modal-{{$headingrow->id}}'>Edit</a>
                      <div class="modal fade" id="modal-{{$headingrow->id}}">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            {{-- <h3>Language</h3> --}}
                            <ul class="nav nav-pills nav-sm">
                              <li class="nav-item active" @if($headingrow->lang =='ar') style="display: none" @endif>
                                <a class="nav-link generalsetting_admin" href data-toggle="tab" data-target="#tab_1">EN</a>
                              </li>
                              <li class="nav-item" @if($headingrow->lang =='en') style="display: none" @endif>
                                <a class="nav-link generalsetting_admin" href data-toggle="tab" data-target="#tab_2">AR</a>
                              </li>
                            </ul>
                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            ...
                            <div class="tab-content">      
                              {{-- English Form Start --}}
                              <div class="tab-pane p-v-sm  @if($headingrow->lang == 'en') active @endif " id="tab_1">
                                <form role="form" method="post" action="{{route('sec_two_heading_put',$headingrow->id)}}" enctype="multipart/form-data">
                                  @csrf
                                  @method('put')
                                  <div class="modal-body">
                                    <div class="form-group">
                              ...
                              <div class="tab-pane p-v-sm @if($headingrow->lang == 'ar') active @endif" id="tab_2" dir="rtl">
                                <form role="form" method="post" action="{{route('sec_two_heading_put',$headingrow->id)}}" enctype="multipart/form-data">
                                  @csrf
                                  @method('put')
                                  <div class="modal-body">
                      ...
                      <form method="post" action="{{route('sec_two_heading_delete',$headingrow->id)}}">
                        @csrf
                        @method('delete')
          ...
          <div class="box-header">
            ...
            <hr>
            @if(count($data) < '6')
              <a href="{{route('sec_two.create')}}" class="btn btn-icon generalsetting_admin"><i class="fa fa-plus"></i></a>
            @endif
          </div>
      ...
      <table class="table table-striped b-t">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="display: flex;">
              <a style="margin-right: 10px;" class="btn btn-default generalsetting_admin" href="{{route('sec_two.show',$row->id)}}"><i class="fa fa-edit "></i></a>
              <form method="post" action="{{route('sec_two.destroy',$row->id)}}">
                @csrf
                @method('delete')
              <button type="submit" onclick="return confirm('Are You Sure Want To Delete This..??')" class="btn btn-default generalsetting_admin"><i class="fa fa-trash "></i></button>
              </form>
