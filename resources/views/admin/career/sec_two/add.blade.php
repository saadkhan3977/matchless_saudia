          ...
          <div class="box-divider m-0"></div>
            <div class="box-body">
              ...
              <div class="tab-content">      
                {{-- English Form Start --}}
                <div class="tab-pane p-v-sm  @if(!count($en) == '3' && count($ar) == '3') active @endif " id="tab_1">
                  <form role="form" method="post" action="{{route('sec_two.store')}}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="tab-pane p-v-sm @if(!count($ar) == '3' && count($en) == '3') active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" action="{{route('sec_two.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
