            ...
            <div class="box-body">
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('sec_one.update',$data->id)}}">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="sub_title" required="" value="{{$data->sub_title}}" placeholder="Enter Sub Title">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="{{ route('sec_one.index') }}" class="btn white m-b generalsetting_admin">Cancel</a>
                  </form>
                </div>
                <div class="tab-pane p-v-sm @if($data->lang == 'ar') active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" enctype="multipart/form-data" action="{{route('sec_one.update',$data->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="sub_title" required="" value="{{$data->sub_title}}" placeholder="أدخل العنوان الفرعي">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="{{ route('sec_one.index') }}" class="btn white m-b generalsetting_admin">إلغاء</a>
                  </form>
                </div>
              </div>
            </div>
