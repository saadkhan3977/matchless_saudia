...
@section('page-title')
    Edit Home Missions Section 4 Heading
@endsection
@section('mainContent')
  <!-- content -->
            ...
            <div class="box-body">
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'en') active @endif" id="tab_1">
                  <form role="form" method="post" enctype="multipart/form-data" action="/admin/home/missions/{{$data->id}}">
                    @csrf
                    @method('put')
                    <div class="form-group">
                      <label for="exampleInputEmail1">Title</label>
                      <input type="text" class="form-control" required="" value="{{$data->title}}" id="exampleInputEmail1" name="title" placeholder="Enter Text">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane p-v-sm @if($data->lang == 'ar') active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" enctype="multipart/form-data" action="/admin/home/missions/{{$data->id}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{$data->title}}" required="" class="form-control" id="exampleInputEmail1" name="title" placeholder="أدخل العنوان">
                    </div>
                    <div class="form-group">
