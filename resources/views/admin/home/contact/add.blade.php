      ...
      <div class="padding">
        <div class="box">
          <div class="box-divider m-0"></div>
            <div class="box-body">
              <h3>Create Home Contact Section</h3>
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm  @if(!$en && $ar) active @endif " id="tab_1">
                  <form role="form" method="post" action="{{route('contact.store')}}">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Map Embed Link Example "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3618.6505205569842!2d67.07762231447853!3d24.909899749410116!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33fbcac4b7627%3A0x31b2a8b32ea56b6b!2sDigitalopment!5e0!3m2!1sen!2s!4v1620612502882!5m2!1sen!2s"</label>
                      <input type="text" class="form-control" required="" name="map_link" id="exampleInputEmail1" placeholder="Enter Sub Title">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane p-v-sm @if(!$ar && $en) active @endif" id="tab_2" dir="rtl">
                  <form role="form" method="post" action="{{route('contact.store')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="map_link" id="exampleInputEmail1" placeholder="أدخل رابط الخريطة">
                    </div>
                    <div class="form-group">
