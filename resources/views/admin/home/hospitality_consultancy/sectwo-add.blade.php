          ...
          <div class="box-divider m-0"></div>
            <div class="box-body">
              ...
              <ul class="nav nav-pills nav-sm">
                <li class="nav-item active" @if(count($en) == '2') style="display: none" @endif>
                  <a class="nav-link generalsetting_admin" href data-toggle="tab" style="margin-right: 5px;" data-target="#tab_1">EN</a>
                </li>
                <li class="nav-item" @if(count($ar) == '2') style="display: none" @endif>
              ...
              <div class="tab-content">      
                ...
                <div class="tab-pane p-v-sm @if(!$en && $ar) active @endif " id="tab_1">
                  <form role="form" method="post" action="{{route('homesectwo_store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="video" required="" placeholder="Enter Video Url">
                    </div>
                    <div class="form-group">
